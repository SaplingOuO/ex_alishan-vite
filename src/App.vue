...
<script setup>
    ...
    const items = reactive([
        ...
        {
            title: '五奇絕景',
            photo: '/public/P_alishan/ali-img-2-md.jpg',
        ...
        {
            title: '鄒族風采',
            photo: '/public/P_alishan/ali-img-3-md.jpg',
        ...
        {
            title: '山林步道',
            photo: '/public/P_alishan/ali-img-4-md.jpg',
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-light shadow">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="/public/P_alishan/alishanLogo.png" style="height: 48px;">
            </a>
        ...
        >
            ...
            ">
                <div class="bg-dark bg-opacity-50 rounded">
                    <div :id="`${item.title}`" class="fs-1">{{ item.title }}</div>
